...
public class TestBigQuerySyncConfig {
  ...
  public void testCopy() {
    ...
    bigQuerySyncConfig.useFileListingFromMetadata = true;
    bigQuerySyncConfig.assumeDatePartitioning = true;
    ...
    assertEquals(copied.datasetLocation, bigQuerySyncConfig.datasetLocation);
    ...
    assertEquals(copied.useFileListingFromMetadata, bigQuerySyncConfig.useFileListingFromMetadata);
    assertEquals(copied.assumeDatePartitioning, bigQuerySyncConfig.assumeDatePartitioning);
  }
}
